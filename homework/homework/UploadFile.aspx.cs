    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (FileUpload1.HasFile)
        {
            ...
            if (Ext.ToUpper() == ".DOCX" || Ext.ToUpper() == ".JPG")
            {
                ...
                LabelUploaded.Text = "อัพโหลดไฟล์สำเร็จ";
            }
            else
            {
                LabelUploaded.ForeColor = System.Drawing.Color.Red;
                LabelUploaded.Text = "ชนิดไฟล์ผิด";
            }
        ...
        else
        {
            ...
            LabelUploaded.ForeColor = System.Drawing.Color.Red;
            LabelUploaded.Text = "กรุณาอัพโหลดไฟล์";
        }

    }
    private void InsertFileDB(string OldFileName, string cPath)
    {
        string StrCon = WebConfigurationManager.ConnectionStrings["homeworkDBConnectionString"].ConnectionString;
